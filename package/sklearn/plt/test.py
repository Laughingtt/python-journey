...
df = pd.read_csv("/Users/tianjian/Projects/python-BasicUsage2/算法/data/my_data_guest.csv")
X_train = df[
    ["w_pct_cnt_to_black", "w_app_cnt_m1", "w_app_time_minus_update_time", "w_cpa_rt_days", "w_cpc_cnt_week_cv"]]
y_train = df[["bad"]]
alpha = lasso_cv_coefs(X_train, y_train, column_names=None)
plt.savefig(f'feature_lasso.svg', bbox_inches='tight')
