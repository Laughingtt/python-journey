...
if __name__ == '__main__':
    id_code = '410326199507103197'
    random_sex = random.randint(0, 1)  # 随机生成男(1)或女(0)
    print(IdNumber.generate_id(random_sex))  # 随机生成身份证号
    print(IdNumber(id_code).area_id)  # 地址编码:410326
    print(IdNumber(id_code).get_area_name())  # 地址:河南省洛阳市汝阳县
    print(IdNumber(id_code).get_birthday())  # 生日:1995-7-10
    print(IdNumber(id_code).get_age())  # 年龄:23(岁)
    print(IdNumber(id_code).get_sex())  # 性别:1(男)
    print(IdNumber(id_code).get_check_digit())  # 校验码:7
